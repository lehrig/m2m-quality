 ...
 */
public class ShapesRule6 {
	/**
	 * The Apache logger.
	 */
	private static final Logger LOGGER = Logger.getLogger(ShapesRule6.class);
	 ...
	 */
	public ShapesRule6(String sourceShapesPath, String targetShapesPath) {
	 ...
	 * First copies the model, then selects every empty block and replaces it by
	 ...
	 * 
	 * @param block
	 *            The block to be used as a template
	 */
	...
	public static void main(String[] modelPaths) {
		ShapesRule6 shapesRule6;
		try {
			shapesRule6 = new ShapesRule6(modelPaths[0], modelPaths[1]);
			shapesRule6.transform();
			shapesRule6.save();
		} catch (Exception e) {
