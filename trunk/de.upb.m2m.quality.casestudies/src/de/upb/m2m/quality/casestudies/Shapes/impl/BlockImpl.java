 ...
 * <ul>
 *   <li>{@link de.upb.m2m.quality.casestudies.Shapes.impl.BlockImpl#getModelElement <em>Model Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BlockImpl extends ShapeImpl implements Block {
	...
	protected EClass eStaticClass() {
		return ShapesPackage.Literals.BLOCK;
	}
	...
	public EList<ModelElement> getModelElement() {
		if (modelElement == null) {
			modelElement = new EObjectContainmentWithInverseEList<ModelElement>(ModelElement.class, this, ShapesPackage.BLOCK__MODEL_ELEMENT, ShapesPackage.MODEL_ELEMENT__BLOCK);
		}
		return modelElement;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ShapesPackage.BLOCK__MODEL_ELEMENT:
