 ...
 * <ul>
 *   <li>{@link de.upb.m2m.quality.model.QualityMetrics.impl.AggregatedRealMetricImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link de.upb.m2m.quality.model.QualityMetrics.impl.AggregatedRealMetricImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link de.upb.m2m.quality.model.QualityMetrics.impl.AggregatedRealMetricImpl#getMedian <em>Median</em>}</li>
 *   <li>{@link de.upb.m2m.quality.model.QualityMetrics.impl.AggregatedRealMetricImpl#getAverage <em>Average</em>}</li>
 *   <li>{@link de.upb.m2m.quality.model.QualityMetrics.impl.AggregatedRealMetricImpl#getStandardDeviation <em>Standard Deviation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AggregatedRealMetricImpl extends MetricImpl implements AggregatedRealMetric {
	...
	protected EClass eStaticClass() {
		return QualityMetricsPackage.Literals.AGGREGATED_REAL_METRIC;
	}
	...
	public void setMinimum(float newMinimum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QualityMetricsPackage.AGGREGATED_REAL_METRIC__MINIMUM, oldMinimum, minimum));
	}
	...
	public void setMaximum(float newMaximum) {
		...
		maximum = newMaximum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QualityMetricsPackage.AGGREGATED_REAL_METRIC__MAXIMUM, oldMaximum, maximum));
	}
	...
	public void setMedian(float newMedian) {
		...
		median = newMedian;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QualityMetricsPackage.AGGREGATED_REAL_METRIC__MEDIAN, oldMedian, median));
	}
	...
	public void setAverage(float newAverage) {
		...
		average = newAverage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QualityMetricsPackage.AGGREGATED_REAL_METRIC__AVERAGE, oldAverage, average));
	}
	...
	public void setStandardDeviation(float newStandardDeviation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QualityMetricsPackage.AGGREGATED_REAL_METRIC__STANDARD_DEVIATION, oldStandardDeviation, standardDeviation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QualityMetricsPackage.AGGREGATED_REAL_METRIC__MINIMUM:
				return getMinimum();
			case QualityMetricsPackage.AGGREGATED_REAL_METRIC__MAXIMUM:
				return getMaximum();
			case QualityMetricsPackage.AGGREGATED_REAL_METRIC__MEDIAN:
				return getMedian();
			case QualityMetricsPackage.AGGREGATED_REAL_METRIC__AVERAGE:
				return getAverage();
			case QualityMetricsPackage.AGGREGATED_REAL_METRIC__STANDARD_DEVIATION:
