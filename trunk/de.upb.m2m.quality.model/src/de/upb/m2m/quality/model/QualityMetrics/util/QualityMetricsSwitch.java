 ...
 * @generated
 */
public class QualityMetricsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case QualityMetricsPackage.METRICS: {
				Metrics metrics = (Metrics)theEObject;
				T result = caseMetrics(metrics);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QualityMetricsPackage.METRIC: {
				Metric metric = (Metric)theEObject;
				T result = caseMetric(metric);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case QualityMetricsPackage.SIMPLE_METRIC: {
			...
			case QualityMetricsPackage.AGGREGATED_INTEGER_METRIC: {
			...
			case QualityMetricsPackage.AGGREGATED_REAL_METRIC: {
