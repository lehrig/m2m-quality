 ...
 * <ul>
 *   <li>{@link de.upb.m2m.quality.model.QualityMetrics.impl.MetricImpl#getMetric <em>Metric</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class MetricImpl extends EObjectImpl implements Metric {
	...
	protected EClass eStaticClass() {
		return QualityMetricsPackage.Literals.METRIC;
	}
	...
	public void setMetric(String newMetric) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QualityMetricsPackage.METRIC__METRIC, oldMetric, metric));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QualityMetricsPackage.METRIC__METRIC:
				return getMetric();
		}
